...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'E:\Cursos 2022\Python UTN\nivel_intermedio\entrega_final\ent_final'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'E:\Cursos 2022\Python UTN\nivel_intermedio\entrega_final\ent_final\Scripts\deactivate.nu'
